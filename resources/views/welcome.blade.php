<!DOCTYPE html>
<html lang="{{ config('app.locale') }}" style="background:url('{{ asset('assets/img/bgpic.jpg') }}') no-repeat center center fixed; background-size: cover; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; margin: 0; padding: 0;">
<head>
	<head>
